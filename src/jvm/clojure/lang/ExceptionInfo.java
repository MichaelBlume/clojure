...
/**
 * Exception that carries data (a map) as additional payload. Clojure programs
 * that need richer semantics for exceptions should use this in lieu of defining
...
public class ExceptionInfo extends RuntimeException implements IExceptionInfo {
  ...
  public ExceptionInfo(String s, IPersistentMap data) {
    ...
    if (data instanceof IPersistentMap) {
      ...
      throw new IllegalArgumentException(
          "Additional data must be a persistent map: " + data);
    }
  }
  ...
  public String toString() {
    return "clojure.lang.ExceptionInfo: " + getMessage() + " "
        + data.toString();
  }
}
