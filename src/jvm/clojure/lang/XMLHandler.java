...
public class XMLHandler extends DefaultHandler {
  ...
  /*
   * public static void main(String[] args){ try { ContentHandler dummy = new
   * DefaultHandler(); SAXParserFactory f = SAXParserFactory.newInstance();
   * //f.setNamespaceAware(true); SAXParser p = f.newSAXParser();
