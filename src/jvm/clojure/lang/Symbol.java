...
public class Symbol extends AFn implements IObj, Comparable, Named,
  ...
  public String toString() {
    if (_str == null) {
      if (ns != null) _str = (ns + "/" + name).intern();
      else _str = name;
    }
    return _str;
  }
  ...
  static public Symbol intern(String nsname) {
    ...
    if (i == -1 || nsname.equals("/")) return new Symbol(null, nsname.intern());
    else return new Symbol(nsname.substring(0, i).intern(), nsname.substring(
        i + 1).intern());
  }
  ...
  public int compareTo(Object o) {
    ...
    if (this.ns == null && s.ns != null) return -1;
    if (this.ns != null) {
      if (s.ns == null) return 1;
