...
public class Intrinsics implements Opcodes {
  ...
  static IPersistentMap ops = RT
      .map(
          ...
          DSUB,
          "public static double clojure.lang.Numbers.inc(double)",
          oa(DCONST_1, DADD),
          "public static double clojure.lang.Numbers.dec(double)",
          oa(DCONST_1, DSUB),
          ...
          DMUL,
          "public static double clojure.lang.Numbers.unchecked_inc(double)",
          oa(DCONST_1, DADD),
          "public static long clojure.lang.Numbers.unchecked_inc(long)",
          oa(LCONST_1, LADD),
          "public static double clojure.lang.Numbers.unchecked_dec(double)",
          oa(DCONST_1, DSUB),
          "public static long clojure.lang.Numbers.unchecked_dec(long)",
          oa(LCONST_1, LSUB),

          "public static short clojure.lang.RT.aget(short[],int)",
          SALOAD,
          "public static float clojure.lang.RT.aget(float[],int)",
          FALOAD,
          "public static double clojure.lang.RT.aget(double[],int)",
          DALOAD,
          "public static int clojure.lang.RT.aget(int[],int)",
          IALOAD,
          "public static long clojure.lang.RT.aget(long[],int)",
          LALOAD,
          "public static char clojure.lang.RT.aget(char[],int)",
          CALOAD,
          "public static byte clojure.lang.RT.aget(byte[],int)",
          BALOAD,
          "public static boolean clojure.lang.RT.aget(boolean[],int)",
          BALOAD,
          "public static java.lang.Object clojure.lang.RT.aget(java.lang.Object[],int)",
          AALOAD, "public static int clojure.lang.RT.alength(int[])",
          ARRAYLENGTH, "public static int clojure.lang.RT.alength(long[])",
          ARRAYLENGTH, "public static int clojure.lang.RT.alength(char[])",
          ARRAYLENGTH,
          "public static int clojure.lang.RT.alength(java.lang.Object[])",
          ARRAYLENGTH, "public static int clojure.lang.RT.alength(byte[])",
          ARRAYLENGTH, "public static int clojure.lang.RT.alength(float[])",
          ARRAYLENGTH, "public static int clojure.lang.RT.alength(short[])",
          ARRAYLENGTH, "public static int clojure.lang.RT.alength(boolean[])",
          ARRAYLENGTH, "public static int clojure.lang.RT.alength(double[])",
          ARRAYLENGTH,
          ...
          "public static double clojure.lang.RT.uncheckedDoubleCast(double)",
          NOP,
          "public static double clojure.lang.RT.uncheckedDoubleCast(float)",
          F2D,
          "public static double clojure.lang.RT.uncheckedDoubleCast(long)",
          L2D, "public static double clojure.lang.RT.uncheckedDoubleCast(int)",
          I2D,
          "public static double clojure.lang.RT.uncheckedDoubleCast(short)",
          I2D,
          "public static double clojure.lang.RT.uncheckedDoubleCast(byte)",
          I2D, "public static long clojure.lang.RT.longCast(long)", NOP,
  ...
  static IPersistentMap preds = RT.map(
      ...
      "public static boolean clojure.lang.Numbers.isZero(double)",
      oa(DCONST_0, DCMPL, IFNE),
      "public static boolean clojure.lang.Numbers.isZero(long)",
      oa(LCONST_0, LCMP, IFNE),
      "public static boolean clojure.lang.Numbers.isPos(long)",
      oa(LCONST_0, LCMP, IFLE),
      "public static boolean clojure.lang.Numbers.isPos(double)",
      oa(DCONST_0, DCMPL, IFLE),
      "public static boolean clojure.lang.Numbers.isNeg(long)",
      oa(LCONST_0, LCMP, IFGE),
      "public static boolean clojure.lang.Numbers.isNeg(double)",
      oa(DCONST_0, DCMPG, IFGE));
}
