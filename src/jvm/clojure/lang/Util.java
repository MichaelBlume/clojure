...
public class Util {
  static public boolean equiv(Object k1, Object k2) {
    ...
    if (k1 != null) {
      if (k1 instanceof Number && k2 instanceof Number) return Numbers.equal(
          (Number) k1, (Number) k2);
      else if (k1 instanceof IPersistentCollection
          || k2 instanceof IPersistentCollection) return pcequiv(k1, k2);
      return k1.equals(k2);
    }
    return false;
  }
  ...
  static EquivPred equivNumber = new EquivPred() {
    public boolean equiv(Object k1, Object k2) {
      if (k2 instanceof Number) return Numbers.equal((Number) k1, (Number) k2);
      return false;
    }
  };
  ...
  static public EquivPred equivPred(Object k1) {
    if (k1 == null) return equivNull;
    else if (k1 instanceof Number) return equivNumber;
    else if (k1 instanceof String || k1 instanceof Symbol) return equivEquals;
    else if (k1 instanceof Collection || k1 instanceof Map) return equivColl;
    return equivEquals;
  }
  ...
  static public boolean pcequiv(Object k1, Object k2) {
    if (k1 instanceof IPersistentCollection) return ((IPersistentCollection) k1)
        .equiv(k2);
  ...
  static public int compare(Object k1, Object k2) {
    ...
    if (k1 != null) {
      if (k2 == null) return 1;
      if (k1 instanceof Number) return Numbers
          .compare((Number) k1, (Number) k2);
  ...
  public static int hasheq(Object o) {
    ...
    if (o instanceof Number) return Numbers.hasheq((Number) o);
    return o.hashCode();
  }
  ...
  static public boolean isInteger(Object x) {
    return x instanceof Integer || x instanceof Long || x instanceof BigInt
