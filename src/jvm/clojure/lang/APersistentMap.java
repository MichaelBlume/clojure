...
public abstract class APersistentMap extends AFn implements IPersistentMap,
    Map, Iterable, Serializable, MapEquivalence, IHashEq {
  int _hash = -1;
  int _hasheq = -1;
  ...
  public IPersistentCollection cons(Object o) {
    if (o instanceof Map.Entry) {
      ...
      if (v.count() != 2) throw new IllegalArgumentException(
    ...
    return new AbstractSet() {
      ...
      public boolean contains(Object o) {
        if (o instanceof Entry) {
          ...
          if (found != null && Util.equals(found.getValue(), e.getValue())) return true;
        }
        return false;
      }
    };
   ...
   *
   * public boolean contains(Object o){ if(o instanceof Map.Entry) { Map.Entry e
   * = (Map.Entry) o; Map.Entry v = entryAt(e.getKey()); return (v != null &&
