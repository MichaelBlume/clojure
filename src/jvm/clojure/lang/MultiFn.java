...
public class MultiFn extends AFn {
  ...
  public MultiFn preferMethod(Object dispatchValX, Object dispatchValY) {
    rw.writeLock().lock();
    try {
      if (prefers(dispatchValY, dispatchValX)) throw new IllegalStateException(
          String
              .format(
  ...
  private IFn getFn(Object dispatchVal) {
    ...
    if (targetFn == null) throw new IllegalArgumentException(String.format(
    ...
    try {
      ...
      for (Object o : getMethodTable()) {
        ...
        if (isA(dispatchVal, e.getKey())) {
          if (bestEntry == null || dominates(e.getKey(), bestEntry.getKey())) bestEntry = e;
          if (!dominates(bestEntry.getKey(), e.getKey())) throw new IllegalArgumentException(
              String
                  .format(
