...
public class PersistentHashMap extends APersistentMap implements
  ...
  public static PersistentHashMap createWithCheck(Object... init) {
    ...
    for (int i = 0; i < init.length; i += 2) {
      ret = ret.assoc(init[i], init[i + 1]);
      if (ret.count() != i / 2 + 1) throw new IllegalArgumentException(
  ...
  static public PersistentHashMap create(ISeq items) {
    ...
    for (; items != null; items = items.next().next()) {
      if (items.next() == null) throw new IllegalArgumentException(
  ...
  static public PersistentHashMap createWithCheck(ISeq items) {
    ...
    for (int i = 0; items != null; items = items.next().next(), ++i) {
      if (items.next() == null) throw new IllegalArgumentException(
          String.format("No value supplied for key: %s", items.first()));
      ret = ret.assoc(items.first(), RT.second(items));
      if (ret.count() != i + 1) throw new IllegalArgumentException(
  ...
  public PersistentHashMap(IPersistentMap meta, int count, INode root,
      boolean hasNull, Object nullValue) {
    this._meta = meta;
    this.count = count;
    this.root = root;
    this.hasNull = hasNull;
  ...
  public IMapEntry entryAt(Object key) {
    if (key == null) return hasNull ? new MapEntry(null, nullValue) : null;
  ...
  public IPersistentMap assoc(Object key, Object val) {
    if (key == null) {
      ...
      return new PersistentHashMap(meta(), hasNull ? count : count + 1, root,
          true, val);
    }
    Box addedLeaf = new Box(null);
    INode newroot = (root == null ? BitmapIndexedNode.EMPTY : root).assoc(0,
        hash(key), key, val, addedLeaf);
  ...
  public Object valAt(Object key, Object notFound) {
    if (key == null) return hasNull ? nullValue : notFound;
  ...
  public IPersistentMap without(Object key) {
    if (key == null) return hasNull ? new PersistentHashMap(meta(), count - 1,
        root, false, null) : this;
  ...
  public Object fold(long n, final IFn combinef, final IFn reducef,
    ...
    Callable top = new Callable() {
      public Object call() throws Exception {
        ...
        if (root != null) ret = combinef.invoke(ret,
            root.fold(combinef, reducef, fjtask, fjfork, fjjoin));
        return hasNull ? combinef.invoke(ret,
            reducef.invoke(combinef.invoke(), null, nullValue)) : ret;
      }
    };
  ...
  static final class TransientHashMap extends ATransientMap {
    ...
    ITransientMap doAssoc(Object key, Object val) {
      ...
      leafFlag.val = null;
      INode n = (root == null ? BitmapIndexedNode.EMPTY : root).assoc(edit, 0,
          hash(key), key, val, leafFlag);
    ...
    void ensureEditable() {
      ...
      if (owner != null) throw new IllegalAccessError(
  ...
  static interface INode extends Serializable {
    ...
    INode assoc(AtomicReference<Thread> edit, int shift, int hash, Object key,
  ...
  final static class ArrayNode implements INode {
    ...
    public INode assoc(int shift, int hash, Object key, Object val,
      ...
      if (node == null) return new ArrayNode(null, count + 1, cloneAndSet(
          array, idx,
    ...
    public INode without(int shift, int hash, Object key) {
      ...
      } else return new ArrayNode(null, count, cloneAndSet(array, idx, n));
    }
    ...
    public Object fold(final IFn combinef, final IFn reducef, final IFn fjtask,
    ...
    static public Object foldTasks(List<Callable> tasks, final IFn combinef,
      ...
      if (tasks.isEmpty()) return combinef.invoke();
    ...
    public INode assoc(AtomicReference<Thread> edit, int shift, int hash,
      ...
      if (node == null) {
        ArrayNode editable = editAndSet(edit, idx,
            BitmapIndexedNode.EMPTY.assoc(edit, shift + 5, hash, key, val,
                addedLeaf));
        editable.count++;
        return editable;
      }
    ...
    static class Seq extends ASeq {
      ...
      private static ISeq create(IPersistentMap meta, INode[] nodes, int i,
          ISeq s) {
        if (s != null) return new Seq(meta, nodes, i, s);
        for (int j = i; j < nodes.length; j++)
          if (nodes[j] != null) {
            ISeq ns = nodes[j].nodeSeq();
            if (ns != null) return new Seq(meta, nodes, j + 1, ns);
          }
        return null;
      }
  ...
  final static class BitmapIndexedNode implements INode {
    ...
    public INode assoc(int shift, int hash, Object key, Object val,
      ...
      if ((bitmap & bit) != 0) {
        ...
        if (keyOrNull == null) {
          INode n = ((INode) valOrNode).assoc(shift + 5, hash, key, val,
              addedLeaf);
          if (n == valOrNode) return this;
          return new BitmapIndexedNode(null, bitmap, cloneAndSet(array,
              2 * idx + 1, n));
        }
        ...
        return new BitmapIndexedNode(null, bitmap, cloneAndSet(array, 2 * idx,
            null, 2 * idx + 1,
        ...
        if (n >= 16) {
          ...
          for (int i = 0; i < 32; i++)
            if (((bitmap >>> i) & 1) != 0) {
              ...
              else nodes[i] = EMPTY.assoc(shift + 5, hash(array[j]), array[j],
                  array[j + 1], addedLeaf);
              j += 2;
            }
    ...
    public INode without(int shift, int hash, Object key) {
      ...
      if (keyOrNull == null) {
        ...
        if (n == valOrNode) return this;
        if (n != null) return new BitmapIndexedNode(null, bitmap, cloneAndSet(
            array, 2 * idx + 1, n));
    ...
    public IMapEntry find(int shift, int hash, Object key) {
      ...
      Object keyOrNull = array[2 * idx];
      Object valOrNode = array[2 * idx + 1];
      if (keyOrNull == null) return ((INode) valOrNode).find(shift + 5, hash,
          key);
      if (Util.equiv(key, keyOrNull)) return new MapEntry(keyOrNull, valOrNode);
      return null;
    }
    ...
    public Object find(int shift, int hash, Object key, Object notFound) {
      ...
      if (keyOrNull == null) return ((INode) valOrNode).find(shift + 5, hash,
          key, notFound);
      if (Util.equiv(key, keyOrNull)) return valOrNode;
      return notFound;
    }
    ...
    public Object fold(IFn combinef, IFn reducef, IFn fjtask, IFn fjfork,
        IFn fjjoin) {
    ...
    private BitmapIndexedNode ensureEditable(AtomicReference<Thread> edit) {
      if (this.edit == edit) return this;
      int n = Integer.bitCount(bitmap);
      Object[] newArray = new Object[n >= 0 ? 2 * (n + 1) : 4]; // make room for
                                                                // next assoc
      System.arraycopy(array, 0, newArray, 0, 2 * n);
      return new BitmapIndexedNode(edit, bitmap, newArray);
    }

    private BitmapIndexedNode editAndSet(AtomicReference<Thread> edit, int i,
        Object a) {
    ...
    private BitmapIndexedNode editAndRemovePair(AtomicReference<Thread> edit,
        int bit, int i) {
      if (bitmap == bit) return null;
      BitmapIndexedNode editable = ensureEditable(edit);
      editable.bitmap ^= bit;
      ...
      if ((bitmap & bit) != 0) {
        ...
        if (n >= 16) {
          ...
          for (int i = 0; i < 32; i++)
            if (((bitmap >>> i) & 1) != 0) {
              if (array[j] == null) nodes[i] = (INode) array[j + 1];
              else nodes[i] = EMPTY.assoc(edit, shift + 5, hash(array[j]),
                  array[j], array[j + 1], addedLeaf);
              j += 2;
            }
    ...
    public INode without(AtomicReference<Thread> edit, int shift, int hash,
      ...
      Object valOrNode = array[2 * idx + 1];
      if (keyOrNull == null) {
        INode n = ((INode) valOrNode).without(edit, shift + 5, hash, key,
            removedLeaf);
        if (n == valOrNode) return this;
  ...
  final static class HashCollisionNode implements INode {
    ...
    public INode assoc(int shift, int hash, Object key, Object val,
      ...
      if (hash == this.hash) {
        ...
        if (idx != -1) {
          ...
          return new HashCollisionNode(null, hash, count, cloneAndSet(array,
              idx + 1, val));
        }
      ...
      return new BitmapIndexedNode(null, bitpos(this.hash, shift),
          new Object[] {null, this}).assoc(shift, hash, key, val, addedLeaf);
    }
    ...
    public INode without(int shift, int hash, Object key) {
      ...
      return new HashCollisionNode(null, hash, count - 1, removePair(array,
          idx / 2));
    }
    ...
    public IMapEntry find(int shift, int hash, Object key) {
      ...
      if (Util.equiv(key, array[idx])) return new MapEntry(array[idx],
          array[idx + 1]);
      return null;
    }
    ...
    public Object find(int shift, int hash, Object key, Object notFound) {
      ...
      if (Util.equiv(key, array[idx])) return array[idx + 1];
      return notFound;
    }
    ...
    private HashCollisionNode ensureEditable(AtomicReference<Thread> edit) {
      if (this.edit == edit) return this;
      Object[] newArray = new Object[2 * (count + 1)]; // make room for next
                                                       // assoc
    ...
    private HashCollisionNode editAndSet(AtomicReference<Thread> edit, int i,
        Object a) {
    ...
    public INode assoc(AtomicReference<Thread> edit, int shift, int hash,
      ...
      if (hash == this.hash) {
        ...
        if (array.length > 2 * count) {
          addedLeaf.val = addedLeaf;
          HashCollisionNode editable = editAndSet(edit, 2 * count, key,
              2 * count + 1, val);
          editable.count++;
          return editable;
        }
      ...
      return new BitmapIndexedNode(edit, bitpos(this.hash, shift),
          new Object[] {null, this, null, null}).assoc(edit, shift, hash, key,
          val, addedLeaf);
    }
   ...
   * s.next(); words.add(word); } System.out.println("words: " + words.size());
   * IPersistentMap map = PersistentHashMap.EMPTY; //IPersistentMap map = new
   * PersistentTreeMap(); //Map ht = new Hashtable(); Map ht = new HashMap();
   * Random rand;
   *
   ...
   * for(Object word1 : words) { ht.put(word1, word1); } rand = new Random(42);
   ...
   *
   * System.out.println("map lookup"); startTime = System.nanoTime(); int c = 0;
   * for(Object word2 : words) { if(!map.contains(word2)) ++c; } estimatedTime =
   * System.nanoTime() - startTime; System.out.println("notfound = " + c +
   * ", time: " + estimatedTime / 1000000); System.out.println("ht lookup");
   * startTime = System.nanoTime(); c = 0; for(Object word3 : words) {
   * if(!ht.containsKey(word3)) ++c; } estimatedTime = System.nanoTime() -
   * startTime; System.out.println("notfound = " + c + ", time: " +
   * estimatedTime / 1000000); System.out.println("snapshotMap lookup");
   * startTime = System.nanoTime(); c = 0; for(Object word4 : words) {
  ...
  private static Object[] removePair(Object[] array, int i) {
    ...
    System.arraycopy(array, 2 * (i + 1), newArray, 2 * i, newArray.length - 2
        * i);
    return newArray;
  }
  ...
  private static INode createNode(int shift, Object key1, Object val1,
    ...
    if (key1hash == key2hash) return new HashCollisionNode(null, key1hash, 2,
        new Object[] {key1, val1, key2, val2});
    Box _ = new Box(null);
    AtomicReference<Thread> edit = new AtomicReference<Thread>();
    return BitmapIndexedNode.EMPTY.assoc(edit, shift, key1hash, key1, val1, _)
  ...
  static final class NodeSeq extends ASeq {
    ...
    static public Object kvreduce(Object[] array, IFn f, Object init) {
      for (int i = 0; i < array.length; i += 2) {
        if (array[i] != null) init = f.invoke(init, array[i], array[i + 1]);
        else {
    ...
    private static ISeq create(Object[] array, int i, ISeq s) {
      if (s != null) return new NodeSeq(null, array, i, s);
      for (int j = i; j < array.length; j += 2) {
        if (array[j] != null) return new NodeSeq(null, array, j, null);
        INode node = (INode) array[j + 1];
        if (node != null) {
          ISeq nodeSeq = node.nodeSeq();
          if (nodeSeq != null) return new NodeSeq(null, array, j + 2, nodeSeq);
        }
      }
      return null;
    }
    ...
    public Object first() {
      if (s != null) return s.first();
      return new MapEntry(array[i], array[i + 1]);
    }

    public ISeq next() {
      if (s != null) return create(array, i, s.next());
